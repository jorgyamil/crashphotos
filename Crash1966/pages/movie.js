    ...
    <div className="flex flex-col items-center justify-center min-h-screen p-16 text-center md:flex-row">
      <div>
        <h1 className="mb-5 text-3xl font-bold">
          Crash (1996) <a className="text-red-500"> 1</a>
        </h1>
        <Image
          src={moviePoster}
          alt="Movie Poster"
        ...
        <p className="mt-1 text-red-500 text-medium">
          Solo 2 posti disponibili. (Tu & yo) beh tambien un shihtzu
        </p>
        <div className="px-12 mt-2">
          ...
          <p className="flex items-center justify-center mt-2 text-justify text-medium px-96">
            ...
            es demasiado largo para escribirlo aqui. Lo importante es que tiene surrealismo, violencia y sex.                         
            
            PD: Devi smettere di picchiare gli anziani e non costringerli più a bere grappa. 🍿
          </p>
        </div>
        <button
